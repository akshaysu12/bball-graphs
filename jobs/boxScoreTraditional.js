...
var boxScoreTraditionalJob = async (input) => {
    data = input.data
    var url = `https://stats.nba.com/stats/playergamelogs?PlayerID=${data.playerId}&Season=${data.season}&SeasonType=${data.seasonType}`
    try {
...
var createJob = async () => {
    ...
    await jobQueue.process('createGame', boxScoreTraditionalJob)
}
createJob();
